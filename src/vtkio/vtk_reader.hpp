...
private:
    ...
    static void parseVTKCellData(std::istream& is, MeshInfo& mesh, std::size_t numCells);

    /// Parse POINT_DATA section (optional)
    static void parseVTKPointData(std::istream& is, MeshInfo& mesh, std::size_t numPoints);
